...
public class QueryGraduateFrame extends JDialog {
    ...
    QueryGraduateFrame(JFrame owner, String title, boolean modal)
    {
        ...
        query_Button.addActionListener(e -> {
            ...
            if (radioID.isSelected())
            {
                ...
                {
                    if (helper.getGraduate(Integer.parseInt(ID_Text.getText())) != null)
                    {
                        ShowGraduateFrame showGraduateFrame =
                                new ShowGraduateFrame(jd,"学生信息展示",helper.getGraduate(Integer.parseInt(ID_Text.getText())));
                    }
                    else
                    {
            ...
            else
            {
                ...
                {
                    if (helper.getGraduate(Integer.parseInt(C_Text.getText()), N_Text.getText()) != null) {
                        ShowGraduateFrame showGraduateFrame =
                                new ShowGraduateFrame(jd, "学生信息展示", helper.getGraduate(Integer.parseInt(C_Text.getText()), N_Text.getText()));
                    } else {
                        JOptionPane.showMessageDialog(jd, "没有找到此学生！");
                        return;
                    }
