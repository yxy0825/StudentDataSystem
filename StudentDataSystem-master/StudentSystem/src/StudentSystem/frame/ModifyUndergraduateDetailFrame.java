...
import StudentSystem.bean.UndergraduateScore;
import StudentSystem.dao.ManageHelper;
import StudentSystem.util.WindowUtil;

import javax.swing.*;

public class ModifyUndergraduateDetailFrame extends JDialog {
    private JButton modify_Button;	//"添加"按钮。
    ...
    ModifyUndergraduateDetailFrame (JDialog owner, String title, boolean modal, int old_StudentID, Undergraduate undergraduate)
    {
        ...
        modify_Button = new JButton("确认");
        modify_Button.setBounds(70, 528, 60, 25);
        modify_Button.addActionListener(e -> {
            ...
            UndergraduateScore score = new UndergraduateScore(Integer.parseInt(math_Text.getText()),Integer.parseInt(java_Text.getText()),Integer.parseInt(english_Text.getText()));
            Undergraduate undergraduate1 = new Undergraduate(Integer.parseInt(student_IDText.getText()),student_NameText.getText(),
                    Integer.parseInt(student_AgeText.getText()),Integer.parseInt(classS_Text.getText()),
                    major_Text.getText(),address,score);
            if(helper.updateUndergraduate(undergraduate1,old_StudentID))
            {
        ...
        cancel_Button.setBounds(230, 528, 60, 25);
        //注册"取消"按钮事件监听
