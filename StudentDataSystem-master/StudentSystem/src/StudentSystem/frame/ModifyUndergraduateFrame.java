...
public class ModifyUndergraduateFrame extends JDialog {
    ...
    ModifyUndergraduateFrame (JFrame owner, String title, boolean modal)
    {
        ...
        select_Button.addActionListener(e -> {
            if (!find_Text.getText().equals(""))
            {
                ...
                Undergraduate undergraduate = helper.getUndergraduate(Integer.parseInt(find_Text.getText()));
                if (undergraduate != null)
                {
                    ModifyUndergraduateDetailFrame modifyUndergraduateDetailFrame =
                        new ModifyUndergraduateDetailFrame(jd,"修改界面",true,Integer.parseInt(find_Text.getText()),undergraduate);
                }
                else
                {
