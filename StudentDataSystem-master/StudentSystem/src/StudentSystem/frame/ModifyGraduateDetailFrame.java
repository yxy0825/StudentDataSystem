...
public class ModifyGraduateDetailFrame extends JDialog
{
    ...
    ModifyGraduateDetailFrame (JDialog owner, String title, boolean modal,int old_StudentID,Graduate graduate)
    {
        ...
        modify_Button = new JButton("添加");
        modify_Button.setBounds(70, 568, 60, 25);
        modify_Button.addActionListener(e -> {
            ...
            Graduate graduate1 = new Graduate(Integer.parseInt(student_IDText.getText()),student_NameText.getText(),
            ...
            if(helper.updateGraduate(graduate1,old_StudentID))
            {
