...
public class AddUndergraduateFrame extends JDialog {
    ...
    private JTextField student_IDText;
    private JTextField student_NameText;
     ...
     */
    public AddUndergraduateFrame(JFrame owner, String title, boolean modal) {
        ...
        add_Button.setBounds(70, 528, 60, 25);
        add_Button.addActionListener(e -> {
            ...
            Undergraduate undergraduate = new Undergraduate(Integer.parseInt(student_IDText.getText()),student_NameText.getText(),
                    Integer.parseInt(student_AgeText.getText()),Integer.parseInt(classS_Text.getText()),
                    major_Text.getText(),address,score);
            if(helper.addUndergraduate(undergraduate))
            {
