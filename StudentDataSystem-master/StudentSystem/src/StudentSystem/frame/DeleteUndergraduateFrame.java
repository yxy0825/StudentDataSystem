...
public class DeleteUndergraduateFrame extends JDialog {
    ...
    public DeleteUndergraduateFrame (JFrame owner, String title, boolean modal)
    {
        ...
        delete_Button.addActionListener(e -> {
            if (helper.deleteUndergraduate(Integer.parseInt(student_IDText.getText())))
            {
